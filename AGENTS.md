...
- **Deployment**: GitHub Pages via Actions (`.github/workflows/deploy.yml`); Vite `base: '/family-wallet/'` + TanStack Router `basepath` in `src/main.tsx`; `404.html` copy trick for SPA routing
